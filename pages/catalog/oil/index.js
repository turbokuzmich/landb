...
const composition = [
  "Органические масла какао, ши, зародышей пшеницы, жожоба",
  "E 1520",
  "Цетиол ультимэйт",
  "Витамин Е",
  "Арома композиция",
...
export default function Oil({ cart }) {
  return (
    <Item id="oil" cart={cart} composition={composition}>
      ...
      структуру кожи и&nbsp;волос (бровей) насыщая, необходимыми для здорового
      внешнего вида, компонентами. Рекомендуется применять, как основу для
